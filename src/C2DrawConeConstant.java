...
public class C2DrawConeConstant {
	...
	//Draw top half of hour glass method
		 ...
		 */
			...
			public static void drawTop() {
				...
				for ( int line = 1; line <SUB_HEIGHT; line++) {            // setup loop of 3
					System.out.print("|");                          
					for (int i = 1; i <= (line -1); i++) {          // setup loop of 2
						System.out.print (" ");
					}
					System.out.print ("\\");
					for (int i = 1; i <= (2 * SUB_HEIGHT - 2 * line); i++) {     //setup loop 0f 4
					System.out.print(".");
					}
					System.out.print("/");
					for (int i = 1; i <= (line -1); i++) {          // setup loop of 2
			...
			public static void drawBottom() {
				...
				for ( int line = 1; line <= SUB_HEIGHT; line++) {            // setup loop of 3
					System.out.print("|");                          
						for (int i = 1; i <= (SUB_HEIGHT - line); i++) {          // setup loop of 2
								System.out.print (" ");
					}
					System.out.print ("/");
